...
const exampleCases = [
  {
    name: "EX01 – Operator A Reload bundle mismatch",
  ...
  {
    name: "EX10 – Operator X EU free-spins domain rules",
  ...
  {
    name: "EX11 – Operator X CIS VIP cashback domain rules",
