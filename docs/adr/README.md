...
This directory contains the architectural decisions made for Promo Preflight.

| # | Title | Status |
|---|---|---|
| [ADR-0001](0001-postgres-over-localstorage.md) | Persist runs in Postgres instead of browser localStorage | Accepted |
