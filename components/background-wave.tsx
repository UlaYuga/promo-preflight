...
export function BackgroundWave() {
  return (
    ...
    >
      ...
      <div
        className="absolute right-[-8%] top-[-5%] h-[120%] w-[55%] animate-[fog-drift_28s_ease-in-out_infinite] blur-[90px]"
        style={{
          background:
      ...
      <div
        className="absolute left-[-5%] bottom-[-10%] h-[90%] w-[40%] animate-[fog-drift_32s_ease-in-out_infinite_4s] blur-[80px]"
        style={{
          background:
      ...
      <div
        className="absolute left-[10%] top-[-20%] h-[70%] w-[55%] animate-[glow-pulse_8s_ease-in-out_infinite] blur-[90px]"
        style={{
          background:
      ...
      <div
        className="absolute right-[-5%] top-[25%] h-[55%] w-[45%] animate-[glow-pulse_10s_ease-in-out_infinite_3s] blur-[80px]"
        style={{
          background:
      ...
      <div
        className="absolute left-[35%] top-[5%] h-[45%] w-[35%] animate-[fog-drift_22s_ease-in-out_infinite_1.5s] blur-[70px]"
        style={{
          background:
      ...
      {/* Bottom atmosphere */}
      <div
        className="absolute bottom-0 left-0 h-[30%] w-full animate-[glow-pulse_12s_ease-in-out_infinite_2s] blur-[50px]"
        style={{
          background:
